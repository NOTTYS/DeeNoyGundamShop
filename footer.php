    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="https://www.facebook.com/DeenoyGundamshop" class="text-reset" target="_blank">Our facebook page</a>
          </p>
        </div>
        <!-- Grid column -->
  ...
  <p style="display: inline-block;">©</p>  <p style="display: inline-block;" id="year"></p> <p style="display: inline-block;">Copyright:</p>
    <a class="text-reset fw-bold" href="https://deenoygundam.com/">www.deenoygundam.com</a>
  </div>
  <!-- Copyright -->
  <script>
